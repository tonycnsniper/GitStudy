define(['SocialNetView', 'text!templates/profile.html', 'text!templates/Status.html', 'model/Status', 'views/Status'], 
			...
			render: function() {
				...
				if( null != statusCollection ) {
					_.each(statusCollection, function(statusJson) {
						...
						$(statusHtml).prependTo('.status_list').hide().fadeIn('show');
					});
				}
			}
		});
